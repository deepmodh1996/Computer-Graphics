...
void SceneLoader::setCylinderDefaults(SceneGroup * n)
{
  ...
  if (n->Cylinder_->height_ == NULL)
  {
    n->Cylinder_->height_ = new ConstValue(1);
  }
}
      ...
      if (readCommand(str, cmd))
      {
        if (cmd == "radius")
        {
          ...
          else
          {
            ...
            std::cout<<n->sphere_->radius_<<"rs"<<values[0]<<std::endl;
          }
        }
      ...
      if (readCommand(str, cmd))
      {
        if (cmd == "radius")
        {
          ...
          else
          {
            ...
            std::cout<<n->Cylinder_->radius_<<"r"<<values[0]<<std::endl;
          }
        }
        else if (cmd == "height")
        {
          ...
          {
            cleanAfter(values, 1);
            n->Cylinder_->height_ = values[0];
            std::cout<<n->Cylinder_->height_<<"h"<<values[0]<<std::endl;
          }
        }
        else if (cmd == "material")
        {
